# 1 "C:\\Users\\brsmi\\OneDrive\\Documentos\\Arduino\\ESPCART\\ESPCART.ino"
# 2 "C:\\Users\\brsmi\\OneDrive\\Documentos\\Arduino\\ESPCART\\ESPCART.ino" 2
# 3 "C:\\Users\\brsmi\\OneDrive\\Documentos\\Arduino\\ESPCART\\ESPCART.ino" 2
# 14 "C:\\Users\\brsmi\\OneDrive\\Documentos\\Arduino\\ESPCART\\ESPCART.ino"
...
# 25 "C:\\Users\\brsmi\\OneDrive\\Documentos\\Arduino\\ESPCART\\ESPCART.ino" 3
                       __attribute__((section( "\".irom.text." "ESPCART.ino" "." "25" "." "9" "\""))) 
# 25 "C:\\Users\\brsmi\\OneDrive\\Documentos\\Arduino\\ESPCART\\ESPCART.ino"
...
void setup()
{
  ...
  // AP
  WiFi.softAP("ESP01-01", "321321321");
  while (!WiFi.softAP("ESP01-01", "321321321"))
  {
    delay(100);
  }
  // STA
  bool conectado = true;
  WiFi.begin("Piso1NSNet", "Panconqueso2.4");
  byte intentos = 0;
